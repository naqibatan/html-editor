    ...
    if soup:
        ...
        if reg_number_tag:
            ...
            if br_tag and br_tag.next_sibling:
                br_tag.next_sibling.replace_with(f" {reg_number_var.get()}")
        ...
        if audit_ref_tag:
            ...
            if br_tag and br_tag.next_sibling:
                br_tag.next_sibling.replace_with(f" {audit_ref_var.get()}")
        ...
        if cert_number_tag:
            ...
            if br_tag and br_tag.next_sibling:
                br_tag.next_sibling.replace_with(f" {cert_number_var.get()}")
        ...
        if eff_date_tag:
            ...
            if br_tag and br_tag.next_sibling:
                br_tag.next_sibling.replace_with(f" {eff_date_var.get()}")
        ...
        if scope_tag:
            ...
            if br_tag and br_tag.next_sibling:
                br_tag.next_sibling.replace_with(f" {scope_var.get()}")
